...
class AdminsTest(GenericTest):
    ...
    def test_puo_creare_un_prodotto(self):
        ...
        body = self.browser.find_element_by_tag_name('body')
        self.assertIn(_('Log In'), body.text)
        ...
        body = self.browser.find_element_by_tag_name('body')
        self.assertIn(_('Dashboard'), body.text)

        # Cerca tra le voci nel menu su quella catalogo
        catalogue_links = self.browser.find_elements_by_link_text(_('Catalogue'))
        ...
        goto_create_product_link = self.browser.find_element_by_link_text(_('Products'))
        goto_create_product_link.click()
        
        # Viene reindirizzato alla pagina di creazione articoli
        body = self.browser.find_element_by_tag_name('body')
        self.assertIn(_('Products'), body.text)
        
        #Preme sul tasto nuovo articolo
        create_product_button = self.browser.find_element_by_xpath("//button[contains(.,'{}')]".format(_('New Product')))
        create_product_button.click()
        
        #Viene reindirizzato alla pagina di creazione articolo
        body = self.browser.find_element_by_tag_name('body')
        self.assertIn(_('Create new Books product'), body.text)
...
class UsersTest(GenericTest):
    ...
    def test_puo_registrarsi(self):
        ...
        self.corpo_contiene_testo(_('Login or register'))
        ...
        self.corpo_contiene_testo(_('Thanks for registering!'))
        ...
        self.corpo_contiene_testo(_('Profile'))
        ...
        save_button = self.browser.find_element_by_xpath("//button[contains(.,'{}')]".format(_('Save')))
        save_button.click()
